...
@section('content')
    <div class="container py-4 mx-auto" style="max-width: 900px; overflow-x: hidden;">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 8px; transition: transform 0.3s ease, box-shadow 0.3s ease;">
            <div class="row g-0">
                    ...
                    <div class="bg-light d-flex align-items-center justify-content-center" style="height: 200px;">
                        ...
                        @else
                            <div class="d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 80px; height: 80px; background-color: #06D6A0; box-shadow: 0 4px 10px rgba(6, 214, 160, 0.3);">
                ...
                <div class="col-md-9 position-relative p-4">
                    <h1 class="h3 fw-bold mb-1" style="color: #06D6A0; font-family: 'Poppins', sans-serif;">{{ $track->title }}</h1>
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        @if(isset($tags) && count($tags) > 0)
                            @foreach($tags as $tag)
                                <span class="badge rounded-pill px-3 py-1" style="background-color: #EDF2F4; color: #2C5364; transition: all 0.3s ease;">{{ $tag->name }}</span>
                            @endforeach
                        @else
                            <span class="badge rounded-pill px-3 py-1" style="background-color: #EDF2F4; color: #2C5364;">Sem tags</span>
                        @endif
                    </div>
                    ...
                    <button
                        ...
                        style="width:60px; height:60px; bottom:15px; right:30px; background-color: #06D6A0; color: white; box-shadow: 0 4px 10px rgba(6, 214, 160, 0.3); display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;"
                        title="Play"
            ...
            <div class="card-body">
                ...
                @if(isset($steps) && count($steps) > 0)
                    @foreach($steps as $index => $step)
                        <div class="d-flex align-items-center border-bottom py-3 position-relative" style="transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='rgba(6, 214, 160, 0.05)'" onmouseout="this.style.backgroundColor=''">
                            ...
                            <div class="flex-grow-1">
                                <div class="fw-semibold" style="color: #06D6A0;">{{ $step->title }}</div>
                            ...
                            <div class="d-flex align-items-center gap-3 me-3">
                                ...
                                <a href="{{ $step->content_url }}" target="_blank" class="btn p-0 border-0" aria-label="Play" title="Assistir" style="color: #06D6A0; transition: all 0.3s ease;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 8px; transition: transform 0.3s ease, box-shadow 0.3s ease;">
            <div class="card-body">
                <h2 class="card-title h5 mb-4 fw-bold" style="color: #06D6A0;">Linha de Frente</h2>
                <div class="d-flex gap-3 overflow-auto pb-2">
                    <div class="text-center" style="width:100px;">
                        ...
                        <div class="small" style="color: #06D6A0; font-weight: 500;">{{ $user->name }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm position-relative" style="border-radius: 8px; transition: transform 0.3s ease, box-shadow 0.3s ease;">
            <div class="card-body">
                <h2 class="card-title h5 mb-4 fw-bold" style="color: #06D6A0;">Recomendações para você</h2>
                <div class="d-flex gap-3 overflow-auto pb-2" style="scrollbar-width: thin; scrollbar-color: #06D6A0 #EDF2F4;">
                    @foreach([
                        ...
                        <div class="card flex-shrink-0" style="min-width: 200px; max-width: 200px; height: 320px; display: flex; flex-direction: column; border-radius: 8px; transition: transform 0.3s ease, box-shadow 0.3s ease;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)';" onmouseout="this.style.transform=''; this.style.boxShadow='';">
                            ...
                            <div class="card-body p-3 flex-grow-1 d-flex flex-column justify-content-between">
                                <h6 class="card-title fw-semibold mb-2" style="min-height: 3.6em; overflow: hidden; text-overflow: ellipsis; color: #06D6A0;">
                                    {{ $rec['title'] }}
                                </h6>
        ...
        <div class="d-flex justify-content-between mb-5">
            ...
            <a href="{{ route('tracks.edit', ['username' => $user->username, 'id' => $track->id]) }}" class="btn" style="background-color: #06D6A0; color: white;">
