...
<style>
    :root {
        ...
        --gradient-primary: linear-gradient(135deg, #203a43 0%, #2c5364 50%, #0f2027 100%);
...
<div class="about-header text-center py-5 position-relative" id="interactive-header" style="background: linear-gradient(135deg, rgb(6, 214, 160) 0%, rgb(32, 58, 67) 100%">
    <!-- Efeito de luz que segue o mouse -->
    ...
    <div class="container position-relative" style="z-index:1;">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center mb-4 mb-md-5 gap-3 mt-3 mt-md-4 animate__animated animate__fadeIn animate__delay-2s">
            <a href="#future" class="btn btn-lg btn-primary bg-hover-dark border-0 px-3 px-md-4 py-2 rounded-4 fw-semibold">
                <span class="d-flex align-items-center justify-content-center gap-2">
                    O nosso compromisso
                </span>
            </a>
            <a href="#team" class="btn btn-outline-light btn-lg px-3 py-2 rounded-4 fw-semibold d-inline-flex align-items-center">
    ...
    <div class="container py-md-5">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-6 order-2 order-lg-1">
                <h2 class="fw-bold text-dark p-0 mb-4">
...
<div class="p-5 my-5 d-flex flex-column align-items-center" id="team">
    <div class="row text-center mb-4">
        <h2 class="fw-bold text-dark p-0 mb-2">
...
<!--div class="container p-5 my-5" id="diferenciais">
    <div class="row align-items-center g-5">
        <div class="col-lg-6 order-lg-1 order-2">
            ...
            <div class="d-flex align-items-center mb-2 mb-md-3">
                <iconify-icon icon="mdi:check-circle" class="text-primary me-2" width="24"></iconify-icon>
            ...
            <a href="{{ route('register') }}" class="btn btn-primary bg-hover-dark btn-lg border-0 rounded-4 fw-bold d-inline-flex align-items-center justify-content-center" style="width: auto;">
...
<div-- class="p-5 d-flex flex-column justify-content-center align-items-center" style="background: var(--gradient-dark);">
    <div class="row pt-5">
        <h2 class="text-center mb-5 fw-bold text-white">O que nos torna diferentes?</h2>
    </div>
    <div class="container row pb-5">
        <div class="col-md-6 col-lg-3">
            <div class="border-start border-4 border-primary ps-3 h-100">
                <iconify-icon icon="mdi:roadmap" width="40" class="my-2 text-primary"></iconify-icon>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="border-start border-4 border-primary ps-3 h-100">
                <iconify-icon icon="mdi:gamepad-variant" width="40" class="my-2 text-primary"></iconify-icon>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="border-start border-4 border-primary ps-3 h-100">
                <iconify-icon icon="mdi:account-group" width="40" class="my-2 text-primary"></iconify-icon>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="border-start border-4 border-primary ps-3 h-100">
                <iconify-icon icon="mdi:chart-line" width="40" class="my-2 text-primary"></iconify-icon>
